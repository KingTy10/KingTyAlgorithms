...
namespace PriorityQueueOFDOOM
{
   ...
   //my code broke didnt know what to do had to look it up on google that why my node class is different compared to the regular demo also worked with luis for my heap and array 
}
